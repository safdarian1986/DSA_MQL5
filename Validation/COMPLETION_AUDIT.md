...
| --- | --- | --- |
| Indicator compiles from final source | PASS | `compile-evidence-20260813-154521-final.log`, `0 errors, 0 warnings` |
| Harnesses compile | PASS | `compile-evidence-20260813-154521-*-harness.log`, all `0 errors, 0 warnings` |
...
| Fast Path priority | PASS | `OnCalculate` runs lightweight rebuild preparation, P0 live path, then historical/adaptive background work; CI source-order guard added |
