...
| --- | --- | --- |
| Indicator compiles from final source | PASS | `compile-evidence-20260813-171623-final.log`, `0 errors, 0 warnings` |
| Harnesses compile | PASS | `compile-evidence-20260813-171623-*-harness.log`, all `0 errors, 0 warnings` |
...
- Latest Strategy Tester run window: `2026-08-13 17:17-17:20` in `C:\Users\ariapars\AppData\Roaming\MetaQuotes\Terminal\D0E8209F77C8CF37AD8BF550E51FF075\Tester\logs\20260813.log`.
